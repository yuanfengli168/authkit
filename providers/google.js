...
const GOOGLE_ICON = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="18" height="18" aria-hidden="true">
...
export default {
  ...
  async unlinkAccount(user) {
    const { unlink } = await import(`${FB_SDK}/firebase-auth.js`);
    return unlink(user._raw ?? user, 'google.com');
  },
};
